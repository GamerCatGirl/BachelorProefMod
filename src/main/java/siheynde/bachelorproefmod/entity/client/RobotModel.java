...
public class RobotModel<T extends RobotEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData ArmsRigth = Robot.addChild(EntityModelPartNames.RIGHT_ARM, ModelPartBuilder.create().uv(0, 2).cuboid(-1.0F, -0.5F, -6.5F, 2.0F, 9.0F, 2.0F, new Dilation(0.0F))
				.uv(0, 2).cuboid(-1.0F, -0.5F, 4.5F, 2.0F, 9.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -11.5F, 0.5F));

		ModelPartData ArmsLeft = Robot.addChild(EntityModelPartNames.LEFT_ARM, ModelPartBuilder.create().uv(0, 2).cuboid(-1.0F, -0.5F, -6.5F, 2.0F, 9.0F, 2.0F, new Dilation(0.0F))
				.uv(0, 2).cuboid(-1.0F, -0.5F, 4.5F, 2.0F, 9.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -11.5F, 0.5F));
