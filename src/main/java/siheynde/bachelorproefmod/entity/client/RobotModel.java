...
public class RobotModel<T extends RobotEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData Robot = modelPartData.addChild("Robot", ModelPartBuilder.create(), ModelTransform.pivot(8.0F, 24.0F, -8.0F));
		...
		.uv(0, 2).cuboid(-1.0F, 4.0F, 1.0F, 2.0F, 4.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-8.0F, -8.0F, 8.0F));

		ModelPartData Body = Robot.addChild("Body", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -5.0F, -5.0F, 9.0F, 9.0F, 9.0F, new Dilation(0.0F)), ModelTransform.pivot(-8.0F, -8.0F, 8.0F));
		...
		.uv(0, 2).cuboid(-1.0F, -0.5F, 4.5F, 2.0F, 9.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-8.0F, -11.5F, 7.5F));
		...
		.uv(0, 3).cuboid(0.0F, -9.0F, -2.0F, 1.0F, 2.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(-8.0F, -8.0F, 8.0F));
		...
		.uv(0, 2).cuboid(0.0F, -14.0F, 5.0F, 1.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-8.0F, -8.0F, 8.0F));
